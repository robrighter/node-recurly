(function(){
  ...
  module.exports = function(config){
    ...
    this.accounts = {
      ...
      forEach: utils.makeForEachIterator(t, routes.accounts.list, 'accounts', 'account'),
    ...
    this.coupons = {
      ...
      forEach: utils.makeForEachIterator(t, routes.coupons.list, 'coupons', 'coupon'),
    ...
    this.invoices = {
      ...
      forEach: utils.makeForEachIterator(t, routes.invoices.list, 'invoices', 'invoice'),
    ...
    this.plans = {
      ...
      forEach: utils.makeForEachIterator(t, routes.plans.list, 'plans', 'plan'),
    ...
    this.planAddons = {
      ...
      forEach: utils.makeForEachIterator(t, routes.planAddons.list, 'add_ons', 'ad_on'),
    ...
    this.subscriptions = {
      ...
      forEach: utils.makeForEachIterator(t, routes.subscriptions.list, 'subscriptions', 'subscription'),
    ...
    this.transactions = {
      ...
      forEach: utils.makeForEachIterator(t, routes.transactions.list, 'transactions', 'transaction'),
      listByAccount: function(accountCode, callback, filter){
        t.request(
          utils.addParams(
