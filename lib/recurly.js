(function () {
  ...
  module.exports = function(config){
    ...
    this.accounts = {
      ...
      get: function(accountcode){
        return new RecurlyRequest('/accounts/'+accountcode, 'GET');
      },
      close: function(accountcode){
    ...
    this.charges = {
      listAll: function(accountcode,  filter){
        return new RecurlyRequest('/accounts/' + accountcode +'/charges'+ ((filter)? '?show='+filter : '' ), 'GET');
      },
      chargeAccount: function(accountcode, details){
    ...
    this.coupons = {
      getAssociatedWithAccount: function(accountcode){
      ...
      redeemOnAccount: function(accountcode, details){
        return new RecurlyRequest('/accounts/' + accountcode + '/coupon', 'POST', js2xml(details,'coupon'));
      },
      removeFromAccount: function(accountcode){
    ...
    this.credits = {
      listAll: function(accountcode){
        return new RecurlyRequest('/accounts/' + accountcode +'/credits', 'GET');
      },
      creditAccount: function(accountcode, details){
    ...
    this.invoices = {
      ...
      invoiceAccount: function(accountcode){
